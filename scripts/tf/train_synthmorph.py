...
p.add_argument('--out-labels', help='labels to optimize, see README')
...
labels_in, label_maps = utils.load_labels(arg.label_dir)
gen = vxm.generators.synthmorph(
    label_maps,
    batch_size=arg.batch_size,
    same_subj=arg.same_subj,
    flip=True,
)  # To get split label_maps
in_shape = label_maps[0].shape

if arg.out_labels is None:
    labels_out = labels_in
elif arg.out_labels.endswith('.npy'):
